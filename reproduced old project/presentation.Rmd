...
## Reproduced data variables histograms with logs

```{r, echo = F, warning=FALSE, message=FALSE, fig.align = "left", out.height= "500px", out.width="950px"}

knitr::include_graphics("img/reproduced_variables_log_histograms.png")  
...
------------------------------------------------------
                           Est.   S.E.   t val.      p
----------------------- ------- ------ -------- ------
(Intercept)               -0.51   0.39    -1.32   0.19
budget_ln                 -0.25   0.01   -17.67   0.00
years_old                  0.05   0.01     5.13   0.00
years_old_squared         -0.00   0.00    -3.21   0.00
revenue_ln                -0.06   0.01    -4.18   0.00
runtime_ln                 1.91   0.08    22.80   0.00
vote_count_ln              0.41   0.02    22.28   0.00
popularity                 0.00   0.00     2.65   0.01
------------------------------------------------------
...
## Poject based on a new dataset
- large dataset from the Kaggle platform containing 650234 movies and TV shows
